// Mengekspor sebuah objek yang berisi URL koneksi ke database MongoDB
module.exports = {
  // Properti 'url' berisi string yang mendefinisikan lokasi server MongoDB dan nama database yang akan digunakan
...
// async function main() {
//   const uri = "mongodb://localhost:27017/collect_vuestore"; // Ganti dengan URI MongoDB Anda
//   const client = new MongoClient(uri);

//   try {
//     await client.connect();
//     const collection = client.db("collect_vuestore").collection("products");
